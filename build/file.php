...
$auth_users = array(
    'zahedce91' => '$2y$10$j0tJKQeSR1nLwWNmJy8OcuYZwacDytyi/Sx3vWh11.mBQMi6DPtnq', //zahed@admin
    'kuet' => '$2y$10$EjfMfkdmvSre17GuTCgiTOvuRgKIkIrTZV082ddOSdRNg3m6DG7Sa' //kuet
);
...
$default_timezone = 'Asia/Dhaka'; // UTC+6

// Root path for file manager
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
//$root_path = $_SERVER['DOCUMENT_ROOT'].'/ffk';
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <img src="https://kuet.ac.bd/libs/img/logo.png">
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://zahed.ffkenterprise.com/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Md. Zahed Hossain</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://zahed.ffkenterprise.com/" target="_blank" class="float-right text-muted">File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://zahed.ffkenterprise.com/" target="_blank" class="float-right text-muted">File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
